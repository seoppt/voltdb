...
public class InternalConnectionHandler {
    ...
    private final Map<Integer, InternalClientResponseAdapter> m_adapters;

    public InternalConnectionHandler(Map<Integer, InternalClientResponseAdapter> adapters) {
        m_adapters = ImmutableMap.copyOf(adapters);
    }
